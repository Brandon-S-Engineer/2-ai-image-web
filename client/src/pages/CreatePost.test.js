...
describe('CreatePost Component', () => {
  ...
  it('generates an image when a valid prompt is provided', async () => {
    ...
    await waitFor(() => {
      expect(global.fetch).toHaveBeenCalledWith('https://2-ai-image-web-lhxt.vercel.app/api/dalle', expect.any(Object));
  ...
  it('submits the post when form is complete and navigates home', async () => {
    ...
    await waitFor(() => {
      ...
      expect(global.fetch).toHaveBeenLastCalledWith(
        'https://2-ai-image-web-lhxt.vercel.app/api/dalle',
